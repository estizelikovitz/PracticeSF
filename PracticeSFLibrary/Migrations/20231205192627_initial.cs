    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contributions", x => new { x.ContributorId, x.SimchaId });
                });

            migrationBuilder.CreateTable(
                name: "ContributionWithIncludes",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContributionWithIncludes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlwaysIncluded = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
